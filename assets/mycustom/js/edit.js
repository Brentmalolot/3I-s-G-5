    ...
    '<div class="container-fluid">\
								<h4 class="alert bg-success">\
									...
									<div class="form-group">\
										...
										<input type="text" name="e_number" class="form-control" readonly value="' +
      data[0] +
      '">\
									</div>\
									<div class="form-group">\
      ...
      '">\
									...
									<div class="form-group">\
										...
										<input type="text" name="e_category" class="form-control" readonly value="' +
      data[6] +
      '">\
									</div>\
									<div class="form-group">\
										<label>Brand</label>\
										<input type="text" name="e_brand" class="form-control" readonly value="' +
      data[7] +
      '">\
									</div>\
									<div class="form-group">\
										<label>Description</label>\
										<textarea name="e_description" class="form-control" readonly>' +
      data[1] +
      '</textarea>\
									</div>\
									<div class="form-group">\
										<label>Quantity</label>\
										<input type="text" name="e_stock" class="form-control" value="' +
      data[2] +
      '" readonly>\
									</div>\
									<div class="form-group">\
      ...
      '" readonly>\
									...
									<div class="form-group">\
										<label>Type</label>\
										<input type="text" name="e_type" class="form-control" readonly value="' +
      data[8] +
      '">\
									</div>\
									<div class="form-group">\
...
$(".item-edit").click(function () {
  ...
  var append =
    '  <form class="frm_edititem">\
                        <h4 class="alert bg-success">Edit Item</h4>\
                        <div class="form-group">\
						<label>Device ID</label>\
							<input type="text" name="e_number" class="form-control" value="' +
    deviceid +
    '" required>\
    ...
    '">\
						...
						<div class="form-group">\
						<label>Photo</label>\
							<input type="file" name="e_photo" class="form-control" value="' +
    e_photo +
    '" required>\
						</div>\
						<label>Model</label>\
							<input type="text" name="e_model" class="form-control" value="' +
    e_model +
    '" required>\
						</div>\
						<div class="form-group">\
    ...
    '</option>\
						...
						<div class="form-group">\
							<label>Brand</label>\
							<input type="text" name="e_brand" class="form-control" value="' +
    e_brand +
    '" required>\
						</div>\
						<div class="form-group">\
							<label>Description</label>\
							<textarea name="e_description" class="form-control" required>' +
    e_description +
    '</textarea>\
						</div>\
						<div class="form-group">\
    ...
    '</option>\
						...
						<label>MR</label>\
							<input type="text" name="e_mr" class="form-control" value="' +
    e_mr +
    '" required>\
						</div>\
						</div>\
						<label>Price</label>\
							<input type="number" name="e_price" class="form-control" value="' +
    e_price +
    '" required>\
						</div>\
						<hr/>\
  ...
  var append =
    ...
    '">\
                        ...
                        <div class="form-group">\
                            ...
                            <input type="number" name="item_emove" min="1" max="' +
    stock +
  ...
  var form =
    '<form class="frm_student_sign">\
					...
					<div class="form-group">\
						...
						<input type="number" name="sid_number" value="' +
    tr[0] +
    '" class="form-control" required autocomplete="off">\
					</div>\
					<div class="form-group">\
						<label>First Name</label>\
						<input type="text" name="s_fname" class="form-control" value="' +
    tr[8] +
    '" required autocomplete="off">\
					</div>\
					<div class="form-group">\
						<label>Last Name</label>\
						<input type="text" name="s_lname" class="form-control" value="' +
    tr[9] +
    '" required autocomplete="off">\
					</div>\
					<div class="form-group">\
    ...
    '</option>\
					...
					<div class="form-group">\
						...
						<input type="tel" name="s_contact" class="form-control" value="' +
    tr[3] +
    '" required autocomplete="off">\
					</div>\
					<div class="form-group">\
    ...
    '</option>\
							...
							<div class="col-md-6">\
								<label>Section</label>\
								<input type="text" name="s_section" class="form-control" value="' +
    yrs[1] +
    '" required autocomplete="off">\
...
table_user.on("click", "a.edit-user", function (e) {
  ...
  var form =
    '<form class="edit_user">\
				...
				<div class="form-group">\
					<label>Name</label>\
					<input type="text" name="u_fname" class="form-control" value="' +
    tr[0] +
    '" required="required">\
				</div>\
				<div class="form-group">\
					<label>Username</label>\
					<input type="text" name="u_username" class="form-control" value="' +
    tr[2] +
    '" required="required">\
				</div>\
				<div class="form-group">\
					<input type="hidden" name="u_id" class="form-control" value="' +
    id +
    '" required="required">\
				</div>\
				<div class="form-group">\
  ...
  var form =
    '<form class="changepass">\
				...
				<div class="form-group">\
					...
					<input type="password" name="c_pass" class="form-control" value="' +
    tr[5] +
